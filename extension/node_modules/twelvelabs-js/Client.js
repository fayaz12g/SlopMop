...
exports.TwelvelabsApiClient = void 0;
...
const Client_1 = require("./api/resources/tasks/client/Client");
const Client_2 = require("./api/resources/indexes/client/Client");
...
class TwelvelabsApiClient {
    ...
    get indexes() {
        var _a;
        return ((_a = this._indexes) !== null && _a !== void 0 ? _a : (this._indexes = new Client_2.Indexes(this._options)));
    }
    get assets() {
        var _a;
        return ((_a = this._assets) !== null && _a !== void 0 ? _a : (this._assets = new Client_3.Assets(this._options)));
    }
    get multipartUpload() {
        var _a;
        return ((_a = this._multipartUpload) !== null && _a !== void 0 ? _a : (this._multipartUpload = new Client_4.MultipartUpload(this._options)));
    }
    ...
    __analyzeStream(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const _response = yield core.fetcher({
...
exports.TwelvelabsApiClient = TwelvelabsApiClient;
