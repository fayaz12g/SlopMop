    ...
    __create(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (request.threshold != null) {
                _request.append("threshold", serializers.ThresholdSearch.jsonOrThrow(request.threshold, { unrecognizedObjectKeys: "strip" }));
            }
            if (request.sortOption != null) {
                _request.append("sort_option", serializers.SearchCreateRequestSortOption.jsonOrThrow(request.sortOption, {
                    unrecognizedObjectKeys: "strip",
                }));
            }
